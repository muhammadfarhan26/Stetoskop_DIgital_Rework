...
import com.tensorflow.android.example.stetoskopdigital1.MainActivity1.TAG_ID
import com.tensorflow.android.example.stetoskopdigital1.RekamSuara
...
class MainActivity : AppCompatActivity() {
    ...
    fun classifyNoise(audioFilePath: String): String? {
        ...
        Log.d("Mfcc :", Arrays.toString(meanMFCCValues))
    ...
    protected fun loadModelAndMakePredictions(meanMFCCValues: FloatArray) : String? {
        ...
        if (null != associatedAxisLabels) {
            ...
            Log.d("Predict :", Arrays.toString(outputTensorBuffer.getFloatArray()))
